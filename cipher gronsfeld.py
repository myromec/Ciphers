...
input_user = input('Введите слово, которое хотите зашифровать: ') # Выписываем слово, которое нам нужно зашифровать
key_user = input('Введите ключ, который хотите использовать: ') # Выписываем ключ, которым мы будем шифровать
